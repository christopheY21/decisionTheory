...
class ARCADSolution(SolutionType):
    pricingServer = {
    ...
    def __init__(self,clientPreference: ClientPreference):
        ...
        self.informationControl = InformationControl(Quantity.ALL,Quantity.ALL) #informationControl()
        self.adBlockerBypass = True #False
        self.componentsNumber = 5# int0
        self.serverCost = ARCADSolution.pricingServer # dict
